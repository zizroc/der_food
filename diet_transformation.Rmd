...
## Comparison of historical supply to future demand
...
grDevices::jpeg(filename = "Plots/figure_S3a.jpg", 
               width = 750, 
               height = 500, 
               units = "px", 
               quality = 1)
...
grDevices::jpeg(filename = "Plots/figure_S3b.jpg", 
               width = 750, 
               height = 500, 
               units = "px", 
               quality = 1)
...
food_feed_proj_diff <- food_proj_diff %>% 
  dplyr::bind_rows(feed_proj_diff) %>% 
...
grDevices::jpeg(filename = "Plots/figure_4a.jpg", 
               width = 750, 
               height = 500, 
               units = "px", 
               quality = 1)
...
grDevices::jpeg(filename = "Plots/figure_S6.jpg", 
               width = 800, 
               height = 500, 
               units = "px", 
               quality = 1)
